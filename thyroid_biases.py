...
# backword propagate
def backprop(Z1_in, Z1, Z2_in, Z2, W1, W2, X, Y, B1, B2):
    # step 6
    dZ2_in = Y - Z2 
...
# update parameters
def update_param(W1, W2, dW2, dW1, A, B1, B2):
    # weights & biasesupdate
    W2 += dW2 * A
    W1 += dW1 * A
    B1 += B1 * A
    B2 += B2 * A
...
def __MAIN__(X_train, Y_train, alpha, epoch):
    ...
    for i in range(epoch):
        ...
        dZ2, dZ1, dW2, dW1 = backprop(Z1_in, Z1, Z2_in, Z2, W1, W2, X, Y, B1, B2)      # backword propagate
        W1, W2, B1, B2 = update_param(W1, W2, dW2, dW1, A, B1, B2)                     # weights & biases update 
